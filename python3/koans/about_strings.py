...
class AboutStrings(Koan):
    ...
    def test_triple_single_quotes_are_also_strings(self):
    ...
    def test_use_single_quotes_to_create_string_with_double_quotes(self):
        ...
        expected = "He said, \"Go Away.\""  # Use " only and escape the inner pair
        self.assertEqual(expected, string)

    def test_use_double_quotes_to_create_strings_with_single_quotes(self):
        string = "Don't"
        expected = 'Don\'t'  # Use ' only and escapte the inner pair
        self.assertEqual(expected, string)
...
It was the worst of times."
    ...
    def test_escaping_quotes_at_the_end_of_triple_quoted_string(self):
        string = """Hello "world\""""
        expected = 'Hello "world"'  # Use a string inside single quotes
        self.assertEqual(expected, string)
